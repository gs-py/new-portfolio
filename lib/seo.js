...
export function pageMeta({
  ...
  return {
    // The layout template ("%s · Gladwin Santhosh") costs 19 chars of a ~60 char
    // SERP budget — home and long article titles opt out of it.
    title: path === "/" || absoluteTitle ? { absolute: absoluteTitle ? title : fullTitle } : title,
    description,
