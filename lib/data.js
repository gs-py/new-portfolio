...
export const headlineStats = [
  { to: 15, suffix: "M", decimals: 0, label: "Search impressions", note: "in three months" },
  { to: 79.7, suffix: "K", decimals: 1, label: "Organic clicks", note: "from near-zero" },
  { to: 5, suffix: "", decimals: 0, label: "Production repos", note: "shipped in parallel" },
  { to: 8, prefix: "#", suffix: "", decimals: 0, label: "Avg. search position", note: "at peak" },
];
