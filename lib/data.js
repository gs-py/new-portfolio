...
export const posts = [
  {
    ...
    seoTitle: "Scaling Organic Search to 15M Impressions in 3 Months",
    excerpt:
      "How a prerendering pipeline, sitemap architecture and a 301 redirect system took a client-rendered React app from invisible to 79.7K organic clicks.",
  ...
  },
  {
    ...
    seoTitle: "Shipping Across 5 Production Codebases",
    excerpt:
      "What owning a full product surface looks like: one booking feature across a React admin, a consumer app, a parent portal, React Native and FastAPI.",
  ...
  },
  {
    ...
    seoTitle: "Building a Trial Booking Flow End-to-End",
    excerpt:
      "The happy path is 10% of the work. International numbers, retried OTPs, expired plans and currency handling are where booking-flow engineering lives.",
